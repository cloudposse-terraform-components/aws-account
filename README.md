...
| <a name="input_import_account_id"></a> [import\_account\_id](#input\_import\_account\_id) | The AWS account ID to import. Set this to import an existing account into Terraform state. Note: Do not set this when the component is disabled (enabled = false). | `string` | `null` | no |
